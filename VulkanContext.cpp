...
void VulkanContext::initVulkan(GLFWwindow* window) {
	...
	//std::cout << "isValidationLayersEnabled:"<< isValidationLayersEnabled <<" checkValidationLayerSupport():"<< !valLayersAndExt->checkValidationLayerSupport() << " final->:" << (isValidationLayersEnabled && !valLayersAndExt->checkValidationLayerSupport()) << std::endl;
